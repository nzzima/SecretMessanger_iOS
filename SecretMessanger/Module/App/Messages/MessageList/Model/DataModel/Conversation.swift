...
struct Conversation {
    ...
    //MARK: Чей аватар показывать в строке списка. У диалога на двоих это собеседник;
    // у группы — никто, и `nil` здесь означает не «нет картинки», а «одной картинкой
    // не обойтись»: участников несколько, и выбирать из них одного было бы враньём.
    var companionId: String? {
        guard !isGroup else { return nil }

        return chat.members.first { $0 != chat.selfId }
    }
